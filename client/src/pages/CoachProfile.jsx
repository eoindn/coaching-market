...
My coaching philosophy centers on authentic leadership and sustainable success. I've had the privilege of working with CEOs, VPs, and senior executives across tech, finance, and healthcare industries, helping them navigate complex challenges while maintaining their core values.`,
    ...
    // Industries
    industries: ["Technology", "Finance", "Healthcare", "Manufacturing", "Consulting", "Real Estate"],
  ...
  const AboutTab = () => (
    <div className="space-y-6">
      {/* Bio Section */}
      <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-white">About</h3>
          {isEditing && <button className="text-blue-400 hover:text-blue-300 font-medium">Edit</button>}
        </div>
        <p className="text-gray-300 leading-relaxed whitespace-pre-line text-lg">{profileData.bio}</p>
      </div>
      ...
      <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {profileData.specialties.map((specialty, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-medium text-center"
            >
              {specialty}
            </div>
          ))}
      ...
      {/* Industries */}
      <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
        <h3 className="text-2xl font-bold text-white mb-6">Industries Served</h3>
        <div className="flex flex-wrap gap-3">
          {profileData.industries.map((industry, index) => (
            <span key={index} className="bg-gray-700 text-gray-300 px-4 py-2 rounded-full text-sm font-medium">
              {industry}
            </span>
          ))}
        </div>
  ...
  const ExperienceTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
        ...
        <p className="text-gray-300 whitespace-pre-line leading-relaxed">{profileData.education}</p>
      </div>
      ...
      <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
        ...
        <div className="flex flex-wrap gap-3">
          {profileData.languages.map((language, index) => (
            <span key={index} className="bg-blue-900/50 text-blue-300 px-4 py-2 rounded-full text-sm font-medium">
              {language}
            </span>
          ))}
        </div>
    ...
    <div className="space-y-6">
      {profileData.testimonials.map((testimonial, index) => (
        <motion.div
          ...
          className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8"
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300 leading-relaxed mb-4 text-lg italic">"{testimonial.text}"</p>
              <div>
  ...
  const ActivityTab = () => (
    <div className="space-y-6">
      {profileData.recentPosts.map((post, index) => (
        <div key={index} className="bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-700 p-8">
          <div className="flex items-start space-x-4">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-2">
                <span className="font-semibold text-white">{profileData.fullName}</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="font-medium text-white">{profileData.contactEmail}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="font-medium text-blue-400">{profileData.website}</div>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="font-medium text-blue-400">View Profile</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="font-medium text-blue-400">@marcuscoaches</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="font-medium text-blue-400">@marcusleadership</div>
              </div>
            </div>
          </div>
        </div>
